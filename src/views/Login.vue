						...
						<div class="formRegion">
							<el-tabs v-model="activeName" @tab-click="handleClick">
								<el-tab-pane label="登录" name="login">
									<el-form ref="Loginform" :model="Loginform" status-icon :rules="rules" label-width="78px" size="mini">
		...
		methods: {
			...
			onRegister() {
				this.$refs['registerForm'].validate(async (valid) => {
					if (valid) {
						let data = {
							sNum : this.registerForm.account,
							sPassword : this.registerForm.password
						}
